/*
  ...
  - The values [TRAINER] on the enum `JobProfileType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "JobProfileType_new" AS ENUM ('CAPTAIN', 'SECRETARY', 'MANAGER');
