...
import TrainingDetailForm from "../Forms/TrainingDetailForm";
...
export default function CourseDetailsPage() {
  ...
  const { isLoading, error, data } = useQuery({
    ...
    queryFn: () => getCourseDetails({ id: courseId!, academyId: academyId! }),
    staleTime: Infinity,
  ...
  const mappedTrainingDetails =
    data.trainingDetails?.map((detail, index) => ({
      id: index.toString(),
      text: detail,
    })) || [];
