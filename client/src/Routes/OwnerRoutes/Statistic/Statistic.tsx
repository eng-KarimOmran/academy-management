...
import DateFilterActions from "@/components/DateFilterActions/DateFilterActions";
import type { DateFormProps } from "@/components/DateFilterActions/forms/DateForm";
      ...
      <main className="space-y-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <CardDashboard
            ...
            value={`${data.ledgerTransaction.totalCollected} ج.م`}
            subtext={`المسترجع: ${data.ledgerTransaction.totalRefund} ج.م`}
